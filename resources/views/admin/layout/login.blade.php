 ...
 <body class="page-account"> 
  ...
  <div class="container clrfix"> 
   ...
   <div class="panel"> 
    ...
    <div class="panel-bd"> 
     <form id="login_form" class="login-form block" action="{{url('admin/login')}}" method="post"> 
      {{csrf_field()}}
      <div class="form-item"> 
       <input class="inputbox" name="auname" type="text" placeholder="用户名" required="" /> 
       <div class="g-error-tip hide"></div> 
      </div> 
      <div class="form-item"> 
       <input class="inputbox" name="aupass" type="password" maxlength="20" placeholder="密码" required="" /> 
       <div class="g-error-tip hide"></div> 
      </div> 
