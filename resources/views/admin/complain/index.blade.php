            ...
            <table class="table table-hover">
                ...
                @foreach ($comp as $v)
                    <tr>
                        ...
                        <td>
                            <font style="vertical-align: inherit;"><font style="vertical-align: inherit;">{{ $v->time }}</font></font>
                        </td>
                        <td>
                            <font style="vertical-align: inherit;"><font style="vertical-align: inherit;">{{ $v->cate }}</font></font>
                        </td>
                        <td>
                            <font style="vertical-align: inherit;"><font style="vertical-align: inherit;">{{ $v->status }}</font></font>
                        </td>
                        <td>
                            <font style="vertical-align: inherit;"><a href="admin/complain" class="btn btn-info"><font style="vertical-align: inherit;">修改</font></a>
                        </font>&nbsp;
