...
<head>
    ...
    <link rel="icon" type="image/png" href="/h/images/favicon.ico"/>
    ...
    <link rel="stylesheet" href="/h/css/common.css?v=2015-5-20"/>
    
    <link rel="stylesheet" href="/h/css/frontPage.css"/>
    

    <!--[if lte IE 7]><script>window.onload=function(){location.href="/ie6warning/"}</script><![endif]-->
    <!--[if lt IE 9]>
    <script src="/h/js/respond.js"></script>
    <script>
    ...
    <section class="common-back" id="wrapBackground">
        ...
        <div id="main-box">
            ...
            <div class="qrCode-frame" ng-hide="qrCodeStatus">
                <img src="/h/images/wx.png" alt="扫描二维码" />
                ...
                <div class="search-box-left search-box-border">
                    <div class="search-box-right search-box-border"  ng-init="city_name='上海'">
                        ...
                        <div class="search-box search-box-border">
                            <form action="{{ url('home/shoplist') }}" method="get">
                            ...
                            <div class="clearfix">
                                ...
                                <button class="btn btn-success fs18 fl"  ng-disabled="searchBtnDisabled" ng-bind="searchBtnName" type="submit">查找餐厅</button>
...
<dh-dialog class="disnone" type='login' height="500" header="登录" show="loginShow" >
    <form class="login-form" novalidate name="loginForm" ng-controller="loginCtrl">
        ...
        <div ng-init="showCaptcha=0" ng-if="showCaptcha" class="form-group inline clearfix mb10">
            ...
            <label class="fr">
                <dh-captcha change="captchaChange" src="/h/images/yzm.gif"></dh-captcha>
            </label>
        </div>
        ...
        <div class="form-group captcha-wrap">
            <div class="clearfix captcha-box">
                ...
                <div class="fl form-group captcha-item">
                    ...
                    <label class="fr">
                        <dh-captcha style="width:119px;height:34px;" change="captchaImgChange" src="/h/images/yzm.gif"></dh-captcha>
                    </label>
                </div>
            </div>
        </div>
...
<!-- <script>
    ...
    <dh-dialog class="disnone" type="alert" index="1001" header="" show="requestError">
     ...
     <ul class="site-fixed">
        <li class="scroll-top"><img src="/h/images/scroll_top1.png" alt=""/> </li>
        <li class="scorll-feekback" ng-click="userFeedback=true">
            <img src="/h/images/scorll_feekback.png" alt=""/>
            <div>意见反馈</div>
        </li>
        <li class="scroll-wx">
            <img src="/h/images/scroll_wx.png" alt=""/>
             <div><img src="/h/images/wx.png" alt=""/></div>
        </li>
    </ul>
    
    <script type="text/javascript" src="/h/js/angular.min.js"></script>
    <script src="/h/js/common.js"></script>
    
    <script type="text/javascript" src="/h/js/api.js"></script>
    <script src="/h/js/service.js"></script>
    
    <script>var feedbackUrl = '/ajax/feedback/';var app = angular.module("app", ["dh.dialog", "dh.form", 'dh.service', 'dh.other']);</script>
    <!--[if lt IE 9]><script src="/h/js/fix.js"></script><![endif]-->
    
    
    <script>var manually_locations='';</script>
    <script src="/h/js/frontPage.js"></script>
