...
<script type="text/javascript" src="/comment/js/jquery-1.4.2.min.js"></script>
...
.quiz_content .btm{border:none;width:100px;height:33px;background:url(/comment/images/btn.gif) no-repeat;margin:10px 0 0 64px;display:inline;cursor:pointer;}
...
/* popinfo */
.popinfo{display:none;position:absolute;top:30px;background:url(/comment/images/comment/infobox-bg.gif) no-repeat;padding-top:8px;width:192px;margin-left:-14px;}
.popinfo .info-box{border:1px solid #f00;border-top:0;padding:0 5px;color:#F60;background:#FFF;}
.popinfo .info-box div{color:#333;}
.rater-click-tips{font:12px/25px;color:#333;margin-left:10px;background:url(/comment/images/comment/infobox-bg-l.gif) no-repeat 0 0;width:125px;height:34px;padding-left:16px;overflow:hidden;}
.rater-click-tips span{display:block;background:#FFF9DD url(/comment/images/comment/infobox-bg-l-r.gif) no-repeat 100% 0;height:34px;line-height:34px;padding-right:5px;}
.rater-star-item-tips{background:url(/comment/images/comment/star-tips.gif) no-repeat 0 0;height:41px;overflow:hidden;}
...
<div class="quiz">
	...
	<div class="quiz_content">
		<form action="{{ url('home/comment/addcmt') }}" id="" method="post">
			{{ csrf_field() }}
			<div class="goods-comm">
				<div class="goods-comm-stars">
					<span class="star_l">满意度：</span>
					满意 : <input type="radio" name="f_satis" value="10" />&nbsp;&nbsp;&nbsp;
					不满意 : <input type="radio" name="f_satis" value="5" />
				</div>
			</div>

			<div class="l_text">
				<label class="m_flo">内  容：</label>
				<textarea name="f_content" id="" class="text"></textarea>
