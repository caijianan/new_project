...
<head>
    ...
    <link rel="icon" type="image/png" href="/d/web/images/favicon.ico"/>
    ...
    <link rel="stylesheet" href="/d/web/css/common.css?v=2015-5-20"/>
    
    <link rel="stylesheet" href="/d/web/css/user_center.css"/>
...
<body class="day " ng-controller="bodyCtrl"  day-or-night>
    <section class="common-back" id="wrapBackground">
        ...
        <div id="main-box">
            ...
            <div class="qrCode-frame" ng-hide="qrCodeStatus">
                <img src="/d/web/images/wx.png" alt="扫描二维码" />
    ...
    <section>
        <div class="user-center-main-box common-width clearfix">
            <aside class="fl">
                <ul>
                    <li class="active">
                        <a href="{{ url('home/account') }}" rel="nofollow">账号管理</a>
                    </li>
                    <li >
    ...
    <dh-dialog class="disnone" type="alert" height="500" index="1001" header="" show="requestError">
     ...
     <ul class="site-fixed">
        <li class="scroll-top"><img src="/d/web/images/scroll_top1.png" alt=""/> </li>
        <li class="scorll-feekback" ng-click="userFeedback=true">
            <img src="/d/web/images/scorll_feekback.png" alt=""/>
            <div>意见反馈</div>
        </li>
        <li class="scroll-wx">
            <img src="/d/web/images/scroll_wx.png" alt=""/>
             <div><img src="/d/web/images/wx.png" alt=""/></div>
        </li>
    </ul>
    
    <script type="text/javascript" src="/d/web/js/angular.min.js"></script>
    <script src="/d/web/js/common.js"></script>
    
     
    <script src="/d/web/js/service.js"></script>
    ...
    <script src="/d/web/js/user_center.js"></script>
