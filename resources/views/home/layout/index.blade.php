...
<![endif]--> 
  <link rel="apple-touch-icon-precomposed" src="/h/images/apple-touch-icon.png?v=2" /> 
  <link rel="shortcut icon" src="/h/images/favicon.ico?v=2" type="image/x-icon" /> 
...
if(!window.CDNReady){var d=new Date;d.setHours(d.getHours()+6);document.cookie="CDNDown=1; domain=ele.me; expires="+d.toUTCString()+"; path=/";if(!window.localStorage.getItem("CDNBackup")){window.localStorage.setItem("CDNBackup",1);location.reload(true)}}
  ...
  <!--[if lt IE 9]>
  <script src="/h/js/html5shiv.js"></script>
<![endif]--> 
  <script type="text/javascript">
 ...
 <body> 
  <!--<![endif]--> 
  <link href="/h/css/background.css?v=5" type="text/css" rel="stylesheet" /> 
  <div id="background" style="background-position:1px -10810.138888889px;" class=" night "> 
   <div id="sun"></div> 
   <div id="moon"></div> 
   <div id="clouds"> 
    <div id="cloudGroup1"> 
     <img src="/h/images/clouds.png" alt="" id="cloudPiece1" class="cloudPiece" /> 
     <img src="/h/images/clouds.png" alt="" id="cloudPiece2" class="cloudPiece" /> 
     <img src="/h/images/clouds.png" alt="" id="cloudPiece3" class="cloudPiece" /> 
    </div> 
    <div id="cloudGroup2"> 
     <img src="/h/images/clouds.png" alt="" id="cloudPiece4" class="cloudPiece" /> 
     <img src="/h/images/clouds.png" alt="" id="cloudPiece5" class="cloudPiece" /> 
     <img src="/h/images/clouds.png" alt="" id="cloudPiece6" class="cloudPiece" /> 
    </div> 
    <div id="cloudGroup3"> 
     <img src="/h/images/clouds.png" alt="" id="cloudPiece7" class="cloudPiece" /> 
     <img src="/h/images/clouds.png" alt="" id="cloudPiece8" class="cloudPiece" /> 
    </div> 
   </div> 
   <div id="bg_stars"> 
     ...
     <div class="mobile-wrap"> 
      ...
      <div id="popup_mobile" class="popup-mobile"> 
       ...
       <div class="panel"> 
        ...
        <a class="qrcode" href="mobile.html" target="_blank"><img src="/h/images/app-qrcode-72.png" alt="扫一扫，手机订餐更方便" /></a> 
