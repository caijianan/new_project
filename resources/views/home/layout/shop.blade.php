...
<html class="no-js" lang="zh">
 <head> 
  ...
  <link class="usemin" rel="stylesheet" href="/h/css/restaurant.92731b91.css" /> 
  ...
  <script>
      ...
      ELEME.route = "restaurant_comment";
      ...
      ELEME.accountHost = "account.ele.me";
            ELEME.csrfToken = "2337f5dd912e308d1058c30ca35ccc5d8234eda7";
            ELEME.timeDelta = 1427465172 - new Date().getTime()/1000;
      ELEME.payHost = "p.ele.me";
    </script> 
  <script>
    ELEME.restaurantUrl = 'hp-jwyb01';
 ...
 <body id="restaurant"> 
    ...
    <div class="mobile-wrap"> 
     ...
     <div id="popup_mobile" class="popup-mobile"> 
      ...
      <div class="panel"> 
       ...
       <a class="qrcode" href="mobile.html" target="_blank"><img src="h/images/app-qrcode-72.85a69c07.png" alt="扫一扫，手机订餐更方便" /></a> 
   ...
   <div class="container rst_header_con"> 
    <article class="rst-header-main rst-header-toggle rst_info_header" itemscope="" itemtype="http://schema.org/Restaurant"> 
     <header class="rst-header-info group"> 
      <a class="rst-logo" href="/hp-jwyb01" itemprop="url"> <img class="rst-logo-img" srcset="http://fuss10.elemecdn.com/c/64/241a5ff7023c8d49bc18495faf417jpg.jpg?w=48&amp;h=48 1x, http://fuss10.elemecdn.com/c/64/241a5ff7023c8d49bc18495faf417jpg.jpg?w=96&amp;h=96 2x" alt="绝味鸭脖" itemprop="logo" /> <i class="icon-rst-badge v v-person" title="该商家已通过个人身份认证"></i> </a> 
      <div class="rst-basic-info"> 
       <div class="rst-name-wrapper caret"> 
        <a class="rst-name text-overflow" href="/hp-jwyb01" data-toggle="bs-tooltip" title="绝味鸭脖" itemprop="name">绝味鸭脖</a> 
       </div> 
       <div class="rst-misc"> 
     ...
     <div class="rst-header-detail rst-header-dropdown"> 
      ...
      <ul class="rst-header-list"> 
       <li><span class="item">时间：</span>09:00 - 22:30</li> 
       <li><span class="item">地址：</span><span itemprop="address">上海市黄浦区中华路9号</span></li> 
      </ul> 
     </div> 
    </article> 
    <nav class="rst-header-nav"> 
     <a class="rst-header-nav-item" href="/hp-jwyb01">菜单</a> 
     <div class="inline-block relative"> 
      <span class="rst-header-nav-tip">看图点菜</span> 
      <a class="rst-header-nav-item" href="/hp-jwyb01/photowall">美食墙</a> 
     </div> 
     <a class="rst-header-nav-item" href="/hp-jwyb01/rating">评价</a> 
     <a class="rst-header-nav-item ui_active" href="/hp-jwyb01/comment">留言</a> 
    </nav> 
  ...
  <script>
      ...
      ga('send','pageview','restaurant_comment/all/hp-jwyb01');
